    ...
    <div class="contenedor seccion seccion-inferior">
            ...
            <article class="entrada-blog">
                <div class="imagen">
                    <picture>
                        ...
                        <img loading="lazy" src="build/img/blog1.jpg" alt="Text Entrada">
                    </picture>
                </div>
            ...
            <article class="entrada-blog">
                <div class="imagen">
                    <picture>
                        ...
                        <img loading="lazy" src="build/img/blog2.jpg" alt="Text Entrada">
                    </picture>
                </div>
                ...
                <div class="texto-entrada">
                    <a href="entrada.html">
                        ...
                        <p class="informacion-meta">escrito el: <span>27/10/2020</span> por: <span>Admin</span></p>

                        <p>
                            Maximisa el espacio en tu hogar con esta guia, aprende a combinar muebles y colore para darle vida a tu espacio  
                        </p>
                    </a>
                </div>
            </article>
        ...
        <section class="testimoniales">
            ...
            <div class="testimonial">
                <blockquote>
                    El personal se comportó de una excelente forma, muy buena atención y la casa que me ofrecierón, cumple con mis expectativas
                </blockquote>
                <p>Saúl Camacho</p>
            </div>
        </section>
